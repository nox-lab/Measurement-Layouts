...
def gen_config_from_demands_batch_random(n_envs: int, filename: str, size_min = 0, size_max = 1.9, dist_min = None, dist_max = 5.3, time_limit = 100, numbered = False, seed = 0) -> tuple[str, list[Demands]]:
  np.random.seed(seed)
  demands_list = []
