...
def train_agent_single_config(configuration_file_train, configuration_file_eval, env_path , log_bool = False, aai_seed = 2023, watch_train = False, watch_eval = False, num_steps = 10000):
...
rewards = train_agent_single_config(configuration_file_train = configuration_file_train, configuration_file_eval = configuration_file_eval, env_path = env_path, watch_train = True, watch_eval=True,  num_steps = 1e4)